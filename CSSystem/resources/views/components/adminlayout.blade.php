...
<aside id="default-sidebar" class="fixed top-0 left-0 z-50 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
  <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <div class="w-full h-40 flex items-center flex-col">
      <img src="/image/DENRLOGO.png" class="w-20 border-2 rounded-full shadow-sm" alt="">
      <p class="text-xl font-mono font-bold mt-2 text-gray-600">{{auth()->user()->firstname}} {{auth()->user()->lastname}}</p>
      ...
      <ul class="space-y-2">
          ...
          <li>
              ...
              <ul id="dropdown-authentication" class="hidden py-2 space-y-2">
                  <li>
                      <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">User Registration</a>
                  </li>
                  <li>
                      <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Logout</a>
                  </li>
                  <li>
